...
import PortfolioGallery from './PortfolioGallery'; // Importujemy komponent galerii
...
const HeroSection = () => {
  ...
  return (
    // Restore original structure with Fragment and separate section/div for gallery
    <>
      ...
      {/* Restore gallery placement outside section with negative margin */}
